<div class="mobile_menu_area">
    <div class="mobile_menu_area_top">
        <a class="mobile_menu_logo" href="index.html">
            <img src="{{ asset('enduser/assets') }}/images/logo.png" alt="EduCore">
        </a>
                    ...
                    <div class="tab-pane fade" id="nav-profile" role="tabpanel"
                        ...
                        <ul class="main_mobile_menu">
                            <li class="mobile_dropdown">
                                <a href="#">
                                    <span>
                                        <img src="{{ asset('enduser/assets') }}/images/menu_category_icon_1.png"
                            ...
                            <li class="mobile_dropdown">
                                <a href="#">
                                    <span>
                                        <img src="{{ asset('enduser/assets') }}/images/menu_category_icon_2.png"
                                            alt="Category" class="img-fluid">
                                    </span>
                                    Business
                                </a>
                            ...
                            <li class="mobile_dropdown">
                                <a href="#">
                                    <span>
                                        <img src="{{ asset('enduser/assets') }}/images/menu_category_icon_3.png"
                                            alt="Category" class="img-fluid">
                                    </span>
                                    Marketing
                                </a>
                            ...
                            <li class="mobile_dropdown">
                                <a href="#">
                                    <span>
                                        <img src="{{ asset('enduser/assets') }}/images/menu_category_icon_4.png"
                                            alt="Category" class="img-fluid">
                                    </span>
                                    Lifestyle
                                </a>
                            ...
                            <li class="mobile_dropdown">
                                <a href="#">
                                    <span>
                                        <img src="{{ asset('enduser/assets') }}/images/menu_category_icon_5.png"
                                            alt="Category" class="img-fluid">
                                    </span>
                                    Health & Fitness
                                </a>
                            ...
                            <li class="mobile_dropdown">
                                <a href="#">
                                    <span>
                                        <img src="{{ asset('enduser/assets') }}/images/menu_category_icon_6.png"
                                            alt="Category" class="img-fluid">
                                    </span>
                                    Design
                                </a>
                            ...
                            <li class="mobile_dropdown">
                                <a href="#">
                                    <span>
                                        <img src="{{ asset('enduser/assets') }}/images/menu_category_icon_7.png"
                                            alt="Category" class="img-fluid">
                                    </span>
                                    Academics
                                </a>
