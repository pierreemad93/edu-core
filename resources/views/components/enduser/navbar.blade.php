b<nav class="navbar navbar-expand-lg main_menu main_menu_3">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="menu_category">
            <div class="icon">
                <img src="{{ asset('enduser/assets') }}/images/grid_icon.png" alt="Category" class="img-fluid">
            </div>
            Category
            <ul>
                <li>
                    <a href="#">
                        <span>
                            <img src="{{ asset('enduser/assets') }}/images/menu_category_icon_1.png" alt="Category"
                                class="img-fluid">
                        </span>
                        Development
                    </a>
                ...
                <li>
                    <a href="#">
                        <span>
                            <img src="{{ asset('enduser/assets') }}/images/menu_category_icon_2.png" alt="Category"
                                class="img-fluid">
                        </span>
                        Business
                    </a>
                ...
                <li>
                    <a href="#">
                        <span>
                            <img src="{{ asset('enduser/assets') }}/images/menu_category_icon_3.png" alt="Category"
                                class="img-fluid">
                        </span>
                        Marketing
                    </a>
                ...
                <li>
                    <a href="#">
                        <span>
                            <img src="{{ asset('enduser/assets') }}/images/menu_category_icon_4.png" alt="Category"
                                class="img-fluid">
                        </span>
                        Lifestyle
                    </a>
                ...
                <li>
                    <a href="#">
                        <span>
                            <img src="{{ asset('enduser/assets') }}/images/menu_category_icon_5.png" alt="Category"
                                class="img-fluid">
                        </span>
                        Health & Fitness
                    </a>
                ...
                <li>
                    <a href="#">
                        <span>
                            <img src="{{ asset('enduser/assets') }}/images/menu_category_icon_6.png" alt="Category"
                                class="img-fluid">
                        </span>
                        Design
                    </a>
                ...
                <li>
                    <a href="#">
                        <span>
                            <img src="{{ asset('enduser/assets') }}/images/menu_category_icon_7.png" alt="Category"
                                class="img-fluid">
                        </span>
                        Academics
                    </a>
        ...
        <div class="right_menu">
            <div class="menu_search_btn">
                <img src="{{ asset('enduser/assets') }}/images/search_icon.png" alt="Search" class="img-fluid">
            </div>
            <ul>
                <li>
                    <a class="menu_signin" href="#">
                        <span>
                            <img src="{{ asset('enduser/assets') }}/images/cart_icon_black.png" alt="user"
                                class="img-fluid">
                        </span>
                        <b>06</b>
                    </a>
