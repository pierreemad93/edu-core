<footer class="footer_3" style="background: url({{ asset('enduser/assets') }}/images/footer_3_bg.jpg);">
                    ...
                    <div class="col-lg-3 wow fadeInUp">
                        <div class="wsus__footer_3_logo_area">
                            <a class="logo" href="index.html">
                                <img src="{{ asset('enduser/assets') }}/images/footer_logo.png" alt="EduCore"
                                    class="img-fluid">
                            </a>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp">
                        <div class="wsus__footer_3_subscribe">
                            ...
                            <ul>
                                <li>
                                    <div class="icon">
                                        <img src="{{ asset('enduser/assets') }}/images/call_icon_white.png"
                                ...
                                <li>
                                    <div class="icon">
                                        <img src="{{ asset('enduser/assets') }}/images/location_icon_white.png"
                                            alt="Call" class="img-fluid">
                                    </div>
                                    <div class="text">
                                        <h4>Office:</h4>
